...
|  MessageType  |                   RequestID                   |
+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
| (ReqID cont.) |   Operation   |      Name Length (Upper)      |
+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
|      Name Length (Lower)      |     Name Bytes (Variable)...  |
+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+                               +
|                                                               |
~                     Name Bytes (Continued)                    ~
|                                                               |
+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
|                    Password Length (UINT32)                   |
+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
...
* reply
  ...
  **OpCheckBalance**
  ...
  |     0x01      |             0x00      0x00      0x00          |
  +-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
  | ReqID (Low 8) | OpCheck (6)   |      Balance (Top 16 bits)    |
  |     0x6A      |     0x06      |       0x40      0x59          |
  +-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
  |                   Balance (Middle 32 bits)                    |
  |     0x20      0x00      0x00      0x00                        |
  +-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
  |                   Balance (Low 16 bits)       |
  |     0x00      0x00                            |
  ...
  |     0x01      |             0x00      0x00      0x00          |
  +-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
  | ReqID (Low 8) | OpIntrst (7)  |      Balance (Top 16 bits)    |
  |     0x6B      |     0x07      |       0x40      0x59          |
  +-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
  |                   Balance (Middle 32 bits)                    |
  |     0x40      0x00      0x00      0x00                        |
